...
function About() {
  return (
    <div className="max-w-[1440px] m-auto px-4 sm:px-6 lg:px-8">
      <div className="mt-[150px] grid grid-cols-1 md:grid-cols-12">
        <div className="md:col-span-5 col-span-12 mt-[80px] ">
          <p className="font-monserat text-xl">Hi There, I'm</p>
        ...
        <div className="md:col-span-7 col-span-12">
          <div className="banner-top ml-16 ">
            <div className="banner_img ml-[80px] mt-[60px] rounded-l-[50%] rounded-tl-[50%] rounded-tr-[50%] border-[15px] relative !z-[999] overflow-hidden border-black w-[60%] flex items-center ">
              <img
                className="w-[82%]"
